    ...
    <div class="card p-4 shadow-sm" style="max-width: 400px; width: 100%;">
        ...
        ?>
            <div class="email">
                ...
                <input type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="Ingrese su correo" required>
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" id="repeat_password" name="repeat_password" placeholder="Repita su contraseña" required>
            ...
            <input name="btnregistrar" id="btnregistrar" class="btn btn-primary w-100" type="submit" value="REGISTRAR" disabled>
