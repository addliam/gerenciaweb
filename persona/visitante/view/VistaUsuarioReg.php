...
<div class="container d-flex justify-content-center align-items-center vh-100">
    <div class="card p-4 shadow-sm" style="max-width: 500px; width: 100%;">
        <h3 class="text-center mb-4">Registro de Persona</h3>
        <form method="POST" action="" class="formulario">
            ...
            if (!isset($_SESSION['usuario_id'])) { //Sesión guardada
                echo '<div class="alert alert-danger">Debes iniciar sesión para registrar una persona.</div>';
                exit; 
            }
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="ocupacion" name="ocupacion" placeholder="Ingrese su ocupación" required>
            </div>
            <div class="mb-3">
                <label for="ingresos" class="form-label">Ingresos</label>
                <input type="number" class="form-control" id="ingresos" name="ingresos" placeholder="Ingrese sus ingresos" required>
            </div>
            <input name="btnregistrar" id="btnregistrar" class="btn btn-primary w-100" type="submit" value="REGISTRAR">
